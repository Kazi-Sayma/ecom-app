                    ...
                    <div class="footer-main">
                        <div class="footer-box">
                            ...
                            <div class="footer-contant">
                                ...
                                <ul class="paymant">
                                    <li><a href="javascript:void(0)"><img src="{{asset('/')}}website/assets/images/layout-1/pay/1.png" class="img-fluid" alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img src="{{asset('/')}}website/assets/images/layout-1/pay/2.png" class="img-fluid" alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img src="{{asset('/')}}website/assets/images/layout-1/pay/3.png" class="img-fluid" alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img src="{{asset('/')}}website/assets/images/layout-1/pay/4.png" class="img-fluid" alt="pay"></a></li>
                                    <li><a href="javascript:void(0)"><img src="{{asset('/')}}website/assets/images/layout-1/pay/5.png" class="img-fluid" alt="pay"></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="footer-box">
...
{{--                    <img src="{{asset('/')}}website/assets/images/theme-modal/black-friday.jpg" class="img-fluid bg-img" alt="">--}}
{{--                    <div>--}}
{{--                        <div>--}}
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img">
                            <img src="{{asset('/')}}website/assets/images/mega-store/product/8.jpg" alt="" class="img-fluid bg-img">
                        </div>
                    </div>
                        ...
                        <div class="media">
                            <div class="img-wraper">
                                <a href="product-page(left-sidebar).html">
                                    <img src="{{asset('/')}}website/assets/images/mega-store/product/9.jpg" alt="" class="img-fluid">
                                </a>
                            </div>
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        <a href="product-page(left-sidebar).html">
                            <img alt="megastore1" class="me-3" src="{{asset('/')}}website/assets/images/mega-store/product/1.jpg">
                        </a>
                        <div class="media-body">
                            <a href="product-page(left-sidebar).html">
                ...
                <li>
                    <div class="media">
                        <a href="product-page(left-sidebar).html">
                            <img alt="megastore1" class="me-3" src="{{asset('/')}}website/assets/images/mega-store/product/2.jpg">
                        </a>
                        <div class="media-body">
                            <a href="product-page(left-sidebar).html">
                ...
                <li>
                    <div class="media">
                        <a href="product-page(left-sidebar).html">
                            <img alt="megastore1" class="me-3" src="{{asset('/')}}website/assets/images/mega-store/product/3.jpg">
                        </a>
                        <div class="media-body">
                            <a href="product-page(left-sidebar).html">
...
<div class="product-notification" id="dismiss">
    ...
    <div class="media">
        <img class="me-2" src="{{asset('/')}}website/assets/images/mega-store/hot-deal/3.jpg" alt="Generic placeholder image">
        <div class="media-body">
