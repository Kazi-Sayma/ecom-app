                        ...
                        <div class="category-left">
                            <div class="header-category">
                                ...
                                <ul class="collapse-category   @if(\Request::route()->getname()== "home") show @else hide @endif">
                                    ...
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/1.png" alt="">furniture</a></li>
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/2.png" alt="">electronics</a></li>
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/3.png" alt="">fashion</a></li>
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/4.png" alt="">medicine</a></li>
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/6.png" alt="">cosmetic</a></li>
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/7.png" alt="">bycycle</a></li>
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/8.png" alt="">shoes</a></li>
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/9.png" alt="">sport</a></li>
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/10.png" alt="">gym</a></li>
                                    <li><a href="category-page(left-sidebar).html"><img src="{{asset('/')}}website/assets/images/mega-store/header-category/11.png" alt="">grocery</a></li>
                                </ul>
                            </div>
                            <div class="logo-block">
                                <div class="mobilecat-toggle "> <i class="fa fa-bars sidebar-bar"></i> </div>
