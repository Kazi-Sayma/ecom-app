            ...
            <div class="col-12 pr-0">
                <div class="category-slide5two no-arrow">
                        ...
                        <div class="category-box">
                            <div class="img-wrraper">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{asset('/')}}website/assets/images/mega-store/category/1.jpg" alt="category" class="img-fluid">
                                </a>
                            </div>
                    ...
                    <div>
                        <div class="category-box">
                            <a href="category-page(left-sidebar).html">
                                <img src="{{asset('/')}}website/assets/images/mega-store/category/2.jpg" alt="category" class="img-fluid">
                            </a>
                            <div class="category-detail">
                                <a href="category-page(left-sidebar).html">
                    ...
                    <div>
                        <div class="category-box">
                            <a href="category-page(left-sidebar).html">
                                <img src="{{asset('/')}}website/assets/images/mega-store/category/3.jpg" alt="category" class="img-fluid">
                            </a>
                            <div class="category-detail">
                                <a href="category-page(left-sidebar).html">
                    ...
                    <div>
                        <div class="category-box">
                            <a href="category-page(left-sidebar).html">
                                <img src="{{asset('/')}}website/assets/images/mega-store/category/4.jpg" alt="category" class="img-fluid">
                            </a>
                            <div class="category-detail">
                                <a href="category-page(left-sidebar).html">
                    ...
                    <div>
                        <div class="category-box">
                            <a href="category-page(left-sidebar).html">
                                <img src="{{asset('/')}}website/assets/images/mega-store/category/5.jpg" alt="category" class="img-fluid">
                            </a>
                            <div class="category-detail">
                                <a href="category-page(left-sidebar).html">
                                    <h2>fresh grocery</h2>
